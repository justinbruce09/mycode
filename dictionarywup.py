...
def main():
    classinfo = {'all': [
     ...
     Justin = (f"My name is {classinfo['all'][9]['name']} and my spirit animal is {classinfo['all'][9]}")
    for classmate in classinfo:
        (f"{classinfo['name'] is {classinfo['skill level']} of a programmer, possesses a/an {classinfo['super power']} for moonlighting as a superhero!")
        print(Justin)
