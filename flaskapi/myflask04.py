...
@app.route("/") # user can land at "/", default request is GET
...
def login():
    #is the incoming  request a POST or GET?
    # the request.method checks this for us 
    # POST would likely come from a user interacting with postmaker.html
    if request.method == "POST":
        #this is where my form was submitted
    ...
    #take user and redirect to another endpoint         
