...
def main():
    ...
    # other+player cannot roll >3
    low_dice = Cheat_Low_Dice()
   ...
   # loaded_dice_score = 0
    ...
    while game_number < number_of_games:
       ...
       # loaded_dice.cheat()
        ...
        if sum(swapper.get_dice()) == sum(low_dice.get_dice()):
            #print("Draw!")
            pass
        elif sum(swapper.get_dice()) > sum(low_dice.get_dice()):
   ...
   # print(f"Loaded dice won: {loaded_dice_score}")
    print(f"low dice won: {low_dice_score}")

    # determine the winner
    if swapper_score == low_dice_score:
        print("Game was drawn")
    elif swapper_score > low_dice_score:
        print("Swapper won most games")
    else:
        print("Low dice won most games")
